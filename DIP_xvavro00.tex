...
\abstract[cs]{Táto práca sa zaoberá vyhľadávaním a automatickou korekciou vybraných patologických nálezov v obrazoch ľudskej sietnice oka. Výber patologických nálezov pre korekciu je zvolený na základe miery dopadu daného nálezu na obraz sietnice s ohľadom na jeho použitie v biometrii.  Práca tiež zahrňuje popis jednoduchého detektoru štruktúry očnej sietnice, ktorý je použitý pre testovanie miery úspešnosti korekcie obrazu sietnice.}
\abstract[en]{This thesis covers recognition and automatic correction of selected pathologic findings in images of human retina. Pathologic findings for correction were selected with respect to the extent of impact of the finding to the retina image when used in biometry. The thesis also includes description of a simple detector of the retina structure which is used in testing of the success rate of correction of the retina image.}
