...
Tieto vlastnosti sú reprezentácie identity. \emph{Identita} je kombináciou všetkých našich vlastností a jednoznačne určuje našu osobu. Každá osoba je teda vždy identická len sama so sebou\cite{bio}.
